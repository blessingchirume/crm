                ...
                <div class="table-responsive">
                    <table class="align-middle mb-0 table table-bordered  table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left text-muted">#{{ $user->id }}</td>
                                <td class="text-left">{{ $user->nmae }} {{ $user->surname }}</td>
                                <td class="text-left">{{ $user->email }}</td>
                                <td class="text-left">{{ $user->organisation }}</td>
                                <td class="text-left">
                                    <div class="badge badge-success">Logged in</div>
                                </td>
                                <td class="text-left">
                                    <button class="mr-2 btn-icon btn-icon-only btn btn-outline-success" onclick="location.href='/user/update/{{ $user->id }}';"><i class="pe-7s-look btn-icon-wrapper"> </i></button>
